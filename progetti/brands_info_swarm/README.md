...
4. N.B. Si presuppone che il build di tutti i progetti sia già state fatto, in quanto all'interno di queste macchine non è installato **Gradle**, se così non fosse effettuarlo esternamente da terminale
